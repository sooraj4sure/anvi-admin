    ...
    <>
      ...
      <div className='flex flex-col gap-2'>
        ...
        <div className='hidden md:grid grid-cols-[1fr_3fr_1fr_1fr_1fr_1fr_1fr] items-center py-1 px-2 border bg-gray-100 text-sm'>
          ...
          {
            list.map((item , index)=>(
              <div className='grid grid-cols-[1fr_3fr_1fr_1fr_1fr_1fr_1fr] md:grid-cols-[1fr_3fr_1fr_1fr_1fr_1fr_1fr] items-center gap-2 py-1 px-2 border text-sm' key={index}>
